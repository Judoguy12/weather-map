...
text = "Droitwich's weather: Status:"+str(sts)+"Wind:"+str(wind)+',Temperature:'+str(temp)+',Rain:'+str(rain)+str(time) 
text2 = 'Humidity and pressure data for Droitwich. Humidity:'+str(humid)+',Pressure:'+str(pressure)+str(time)
